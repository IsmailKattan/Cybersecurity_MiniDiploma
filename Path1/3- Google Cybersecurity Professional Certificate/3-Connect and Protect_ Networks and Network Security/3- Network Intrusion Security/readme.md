...
**tcpdump** هو محلل بروتوكول شبكة (Network Protocol Analyzer) يعمل عبر سطر الأوامر (Command-line). إنه شائع وخفيف (يستخدم ذاكرة قليلة واستهلاك CPU منخفض)، ويستخدم مكتبة libpcap مفتوحة المصدر. يعمل tcpdump بشكل نصي، حيث يتم تنفيذ جميع الأوامر في الطرفية (Terminal).
